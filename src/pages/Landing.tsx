  ...
  const qrCodes = [
    {
      ...
      logoSrc: kpmgLogo,
      linkHref:
        "https://mitt.systemvetardagen.se/?exhibitor=-LVSgu9lKbWTgir5fIeZ",
    ...
    },
    {
      ...
      linkHref:
        "https://mitt.systemvetardagen.se/?exhibitor=-OL7mOFFhsOa4zLpQ-h_",
    ...
    },
    {
      ...
      linkHref:
        "https://mitt.systemvetardagen.se/?exhibitor=-OL5DkXmD3RY9LyE_q48",
    ...
    },
    {
      ...
      linkHref:
        "https://mitt.systemvetardagen.se/?exhibitor=-OL7mSABtS6L1XeNNS9a",
    ...
    },
    {
      ...
      linkHref:
        "https://mitt.systemvetardagen.se/?exhibitor=-OL5CyNSKRxUPJzmgNeB",
      ...
      <div className="overflow-hidden font-poppins">
        <div className="h-screen max-h-[1200px] w-screen gradient-background text-white flex flex-col items-center justify-evenly py-[15vh] min-w-[351px] font-poppins tracking-wide">
          <div className="text-center mt-8">
            <h1 className="text-4xl fadeRight">{t("sub-header")}</h1>
        ...
        <div className="w-screen px-[7vw] md:px-[15vw] lg:px-[20vw] py-[4vw] flex flex-col items-center justify-center gap-10 bg-background text-text text-center">
          ...
          <div className="flex flex-col md:flex-row gap-10 w-full">
            {[
              ...
              <FadeInSection
                key={index}
                direction={index % 2 === 0 ? "fadeLeft" : "fadeRight"}
            ...
            <div className="bg-[#FFEAC9] rounded-3xl py-10 text-center items-center flex flex-col gap-10 shadow-lg w-full">
              ...
              <div className="w-[90%] flex flex-col gap-8 md:flex-row md:gap-0 justify-evenly">
                {["before", "during"].map((period) => (
                  <FadeInSection direction="fadeUp" key={period}>

...
interface PreSignup {
  ...
  lastName: string;
  email: string;
  program: CandidateProgram | MasterProgram | "";
}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-start space-x-2">
            ...
            <label className="text-sm text-gray-600">
              By checking this box, you consent to the collection and storage of
              the provided information in accordance with GDPR and to receiving
              emails about Systemvetardagen.
            </label>
          </div>
